-- 提取双联抗板的用药患者和用药信息
CREATE TABLE CAD_DUL_ANTIPLATELET_DRUG AS
SELECT
    a.*,
    b.DRUG_DAY
...
JOIN (
    ...
    FROM KSQC_2024.SQC_WM_PRESCRIPTIONS_ALL
    WHERE CAT_CODE = 'XB01AC'
    GROUP BY GLOBAL_INDEX, ORGAN_NAME, TRUNC(DRUG_DATE)
...
SELECT
    ...
    d.DRUG_DAY AS therapy_start_date,
    d.DRUG_NAME,
    d.DRUG_DATE,
    d.CAT_CODE
